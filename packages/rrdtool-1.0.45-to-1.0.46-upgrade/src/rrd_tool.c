/*****************************************************************************
 * RRDtool 1.0.45  Copyright Tobias Oetiker, 1997 - 2001
 *****************************************************************************
...
void PrintUsage(char *cmd)
{
    ...
    char help_main[] =
	   "RRDtool 1.0.45  Copyright 1997-2001 by Tobias Oetiker <tobi@oetiker.ch>\n\n"
...
int HandleInputLine(int argc, char **argv, FILE* out)
{
	...
	free(data);
	     ...
	     strcmp("-v", argv[1]) == 0  ||
	     strcmp("-version", argv[1]) == 0  )
        printf("RRDtool 1.0.45  Copyright (C) 1997-2001 by Tobias Oetiker <tobi@oetiker.ch>\n");
